<template>
  <div>
    ...
    <!-- Type Section -->
    <section class="sect sect--type">
      <div class="container">
        <div class="row row--center">
          <div class="col-md-5 col-xs-8 col-sm-6 col--inbl">
            <h1 class="sect__title">We believe in coffee that tastes incredible</h1>
        ...
        <div class="row row--small row--margin row--center">
          <div v-for="coffee in coffees" :key="coffee.name" class="col-md-4 col-sm-4 coffee">
            <img :src="coffee.img" class="coffee__img" />
            <h2 class="coffee__name">{{ coffee.name }}</h2>
            <p class="coffee__descr">{{ coffee.description }}</p>
          </div>
        </div>
    ...
    <!-- Our Story -->
    <section class="sect sect--brown sect--no-bottom">
      <div class="container">
        <div class="row row--center">
    ...
    <section class="sect sect--great">
      <div class="container">
        <div class="row">
          <div class="col-md-5 col-sm-7 col-sm-offset-4 col-md-offset-6">
            <div class="description">
              <h2 class="description__title">GREAT COFFEE</h2>
              <p class="description__p">
                Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium...
              </p>
              <a href="#" class="btn">Learn more</a>
    ...
    <!-- Best Coffee Shop -->
    <section class="sect sect--best sect--center">
      <div class="container">
        <div class="row row--center">
          <div class="col-md-6 col-sm-7 col-xs-12">
            <h1 class="sect__title best--bottom sect--white-text">The best coffee shop</h1>
            <div class="row">
              <div v-for="(icon, index) in icons" :key="index" class="col-md-4 col-sm-4 col-xs-4">
                <img :src="icon" class="best__img" />
                <h2 class="best__title">Best beans</h2>
              </div>
            </div>
    ...
    <section class="three-img">
      <div v-for="(imgClass, idx) in [1, 2, 3]" :key="idx" :class="`col-md-4 col-sm-4 col-xs-4 three-img__img three-img--${imgClass}`"></div>
    </section>

    <!-- Blog Section -->
    <section class="sect blog sect--grey">
      <div class="container">
        <div class="row row--center">
          <div class="col-md-5 col-sm-6 col--inbl">
            <h1 class="sect__title">Latest from blog</h1>
            <p class="sect__subtitle">
              Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque...
            </p>
          </div>
        ...
        <div class="row last-articles">
          <div v-for="(article, index) in blogArticles" :key="index" class="col-md-4 col-sm-4">
            <div :class="`article-pre article-pre-${index + 1}`">
              <div class="article-pre__img"></div>
              <div class="article-pre__info">
                <h1 class="article-pre__title">{{ article.title }}</h1>
                <span class="article-pre__date">{{ article.date }}</span>
                <p class="article-pre__ex">{{ article.excerpt }}</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div ref="footerSpacer" class="sect-t-footer"></div>
    ...
    <footer ref="footer" class="footer">
      ...
      <div class="footer__half footer__half-2">
        ...
        <p class="footer__desc">543 TN, doula street<br />NY, New York</p>
      </div>
    </footer>
  </div>
</template>
...
const footerSpacer = ref<HTMLElement | null>(null)

onMounted(() => {
  if (footer.value && footerSpacer.value) {
    footerSpacer.value.style.height = `${footer.value.offsetHeight}px`
  }
})
...
const coffees = [
  {
    name: 'Mocha latte',
    img: 'https://image.ibb.co/bKy6Db/coffee_item_2.png',
    description:
      'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.',
  },
  {
    name: 'Pour over',
    img: 'https://image.ibb.co/nN0WeG/coffee_item_1.png',
    description:
      'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.',
  },
  {
    name: 'Espresso',
    img: 'https://image.ibb.co/dHQa6w/coffee_item_3.png',
    description:
      'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.',
  },
]
...
const icons = [
  'https://image.ibb.co/n5gUtm/icon_1.png',
  'https://image.ibb.co/dwEXDm/icon_2.png',
  'https://image.ibb.co/j5Og66/icon_3.png',
]
...
const blogArticles = [
  {
    ...
    date: 'Sep 27, 2017',
    excerpt:
      'Augue interdum velit euismod in pellentesque massa. Amet nisl suscipit adipiscing bibendum est...',
  },
  {
